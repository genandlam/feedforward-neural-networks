...
def build_model(learning_rate,n):
    model = models.Sequential()
    model.add(Dense(n,kernel_regularizer=regularizers.l2(beta)
                    ,activation='relu', 
...
#    model.summary()
    ...
    history = model.fit(test_data, y_test, 
...
model,history=build_model(learning_rate=1e-10 ,n=100)
...
plt.legend()
plt.savefig('./Pb_3b_mean_squared_error.png')
plt.show()